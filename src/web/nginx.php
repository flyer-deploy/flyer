...
use function \NginxConf\create_try_files_directive;
use function \NginxConf\create_error_page_directive;

require __DIR__ . '/../common/utils/path.php';
require __DIR__ . '/../common/utils/substitute.php';
require __DIR__ . '/../common/utils/filesystem.php';

require __DIR__ . '/../pkg/nginx-conf-builder/builder.php';
    ...
    foreach ($directives as $directive) {
        foreach ($directive as $name => $params) {
            if ($name == 'location') {
                ...
                $location_block = new LocationBlock($modifier, $path);
...
task('hook:post_release', function () {
    ...
    $block = new LocationBlock('', path_join('/', $web_basepath));
